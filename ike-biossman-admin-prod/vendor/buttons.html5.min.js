...
(function (n) {
    ...
    var K = function (a) {
        if (!("undefined" === typeof a || "undefined" !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent))) {
            var c = a.document.createElementNS("https://www.w3.org/1999/xhtml", "a"),
                d = "download" in c,
    ...
    D.ext.buttons.excelHtml5 = {
        ...
        action: function (a, c, d, b) {
            ...
            var p = c.buttons.exportData(b.exportOptions),
                t, h, q = function (k) {
                    ...
                    for (var l = 0, z = k.length; l < z; l++) {
                        ...
                        A || ("number" === typeof k[l] || k[l].match && k[l].match(/^-?\d+(\.\d+)?$/) && !k[l].match(/^0\d+/) ?
                            A = y(f, "c", {
                                attr: {
                                    t: "n",
                                    r: G
            ...
            v = 0;
            for (C = p.header.length; v < C; v++) q.appendChild(y(f,
                "col", {
                    attr: {
                        min: v + 1,
                        max: v + 1,
